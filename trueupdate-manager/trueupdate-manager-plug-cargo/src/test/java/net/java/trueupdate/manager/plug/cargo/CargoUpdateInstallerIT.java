...
public class CargoUpdateInstallerIT {

    private static final Logger
            logger = Logger.getLogger(CargoUpdateInstallerIT.class.getName());

    public static @Deployment WebArchive createDeployment() {
        final WebArchive archive = ShrinkWrap
                .create(WebArchive.class)
                .addClass(CargoUpdateInstaller.class)
    ...
    public @Test void testInjection() {
        assert installer instanceof CargoUpdateInstaller;
    }
}
