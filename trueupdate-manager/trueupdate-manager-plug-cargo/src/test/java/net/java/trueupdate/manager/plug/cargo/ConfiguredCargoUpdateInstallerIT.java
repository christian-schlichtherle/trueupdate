...
public class ConfiguredCargoUpdateInstallerIT {

    private static final String
            NAME = ConfiguredCargoUpdateInstallerIT.class.getSimpleName();
    ...
    private static final Logger
            logger = Logger.getLogger(ConfiguredCargoUpdateInstallerIT.class.getName());
